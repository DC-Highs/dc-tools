...
import { type DragonSpineAnimationDownloaderFormValues } from "@/schemas/dragon-spine-animation-downloader-form.schema"
...
interface DragonSpineAnimationFormProps {
    form: UseFormReturn<DragonSpineAnimationDownloaderFormValues>
    onSubmit: (data: DragonSpineAnimationDownloaderFormValues) => void
    isDownloading: boolean
    handleCopyUrl: () => void
}

export const DragonSpineAnimationForm: FC<DragonSpineAnimationFormProps> = ({
    form,
    onSubmit,
    isDownloading,
    handleCopyUrl,
