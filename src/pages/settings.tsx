                            ...
                            <FieldGroup>
                                <Field>
                                    ...
                                    <PasswordInput
                                        ...
                                        {...form.register("convertio.apiKey")}
                                    />
                        ...
                        <CardContent>
                            <FieldGroup className="grid gap-4 sm:grid-cols-2">
                                <Field className="sm:col-span-2">
                                    ...
                                    <Input placeholder="https://api.example.com" {...form.register("gameConfig.url")} />
                                    <FieldError errors={[form.formState.errors.gameConfig?.url]} />
                                </Field>
                                <Field>
                                    <FieldLabel>User ID</FieldLabel>
                                    <Input placeholder="User ID" {...form.register("gameConfig.userId")} />
                                ...
                                <Field className="sm:col-span-2">
                                    ...
                                    <PasswordInput
                                        ...
                                        {...form.register("gameConfig.authToken")}
                                    />
